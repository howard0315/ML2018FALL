...
def SplitSentence():
	...
	FullDict = [' '.join(ch) for dt in FullDict for st in dt for ch in st]
...
def TrainSaveW2V(LSF):
	...
	print('====================')
	W2Vmodel.save('./W2V/W2V_SC.model')
	return W2Vmodel
...
if __name__ == '__main__':
	...
	file = open('./WordEmbedding/embedding_matrix_SC.pickle', 'wb')
	pickle.dump(embedding_matrix, file)
	file.close()
	
	file = open('./WordEmbedding/word2idx_SC.pickle', 'wb')
